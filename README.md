...
### In the retriever 🔍 component, you can select your modify parameters and see how your selected desired chunks rank between different indexing methods.
![retriever open](images/retriever_open.png)

### In the llm 🧠 component you can tweak prompts and remove inserted context, to see how that effects downstream that effects the response.
...
By selecting run all, you will continue running the pipeline after where you left off, but continue with the modified outputs of the retriever or llm component you selected. Affected downstream components will be highlighted in red.
